...
], function (Controller, UIComponent, History, MessageToast, Device, Filter, FilterOperator, Fragment, syncStyleClass) {
	"use strict";

	return Controller.extend("Trade_Finance.Trade_Finance.controller.BaseController", {
		/**
