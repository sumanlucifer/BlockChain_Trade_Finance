sap.ui.define([
	...
	return BaseController.extend("Trade_Finance.Trade_Finance.controller.submitlcviewDetails", {
		...
		onBuyerSubmittedMatched: function (oEvent) {
			...
			this.getModel("BuyerSubmitModel").loadData(sBuyerSmittigUri,
				...
				var url = "https://blockchaintradefinance.cfapps.eu10.hana.ondemand.com/api/lcHistory/getLcHistoryByLcToken/" + that.getModel(
					"BuyerSubmitModel").getProperty("/data/LCTokenNumber");
				jQuery.ajax({
					type: "GET",
		...
		onlogoutPress: function () {
			 ...
			 * @memberOf Trade_Finance.Trade_Finance.view.submitlcviewDetails
			 */
