sap.ui.define([
	...
	return BaseController.extend("Trade_Finance.Trade_Finance.controller.newlcbuyerbankviewDetails", {
		...
		onBuyerSubmittedMatched: function (oEvent) {
			...
			this.getModel("BuyerbankSubmitModel").loadData(sBuyerPendingUri,
				null, true, "GET", null,
				false, {
				...
				that.getView().getModel("buyerbankPendingView").setProperty("/token", that.getModel("BuyerbankSubmitModel").getProperty(
					"/data/LCTokenNumber"));
		 ...
		 * @memberOf Trade_Finance.Trade_Finance.view.newlcbuyerbankviewDetails
		 */
