sap.ui.define([
	...
	"use strict";
	var that;
	return BaseController.extend("Trade_Finance.Trade_Finance.controller.reviwedlcsellerviewDetails", {
		...
		onInit: function () {
			...
			that = this;
			this.setModel(oViewModel, "SellerSubmitView");
			this.getRouter().getRoute("reviwedlcsellerviewDetails").attachMatched(this.onSellerSubmittedMatched, this);
		...
		onSellerSubmittedMatched: function (oEvent) {
			...
			this.getModel("SellerSubmittedModel").loadData(sBuyerSmittigUri,
				null, true, "GET", null,
				false, {
				...
				that.getView().getModel("SellerSubmitView").setProperty("/token", that.getModel("SellerSubmittedModel").getProperty(
					"/data/LCTokenNumber"));
		...
		onlogoutPress: function () {
			 ...
			 * @memberOf Trade_Finance.Trade_Finance.view.reviwedlcsellerviewDetails
			 */
